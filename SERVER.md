...
```
# CRIAR NO SERVIDOR UMA CHAVE PARA ACESSAR O REPOSITÓRIO DO GITHUB
ssh-keygen
# Irá gerar no endereço /root/.ssh/
# execute o comando abaixo para listar o conteúdo da pasta inclusive arquivos ocultos e com tamanho do arquivo.
cd /root/.ssh/
ls -lah
cat id_rsa.pub
```
